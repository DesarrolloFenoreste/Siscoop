 ...
 * @author gerardo
 */
@XmlRootElement(name = "SegurosComisionesDTO")
public class SegurosComisionesDTO implements Serializable {
    ...
    public SegurosComisionesDTO() {
    }

    public SegurosComisionesDTO(int idorigenp, int idproducto, int idauxiliar) {
    ...
    public boolean equals(Object obj) {
        ...
        final SegurosComisionesDTO other = (SegurosComisionesDTO) obj;
