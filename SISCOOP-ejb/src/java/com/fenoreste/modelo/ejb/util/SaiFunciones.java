...
public class SaiFunciones extends AbstractFacade<Auxiliares> {
...
// Ejecuta el sai_auxiliar y lo retorna en un array de string
    ...
    public int saiPromocionPuntosSaicoop(int idusuario, String sesion, String fechaTrabajo, int idorigenc, int idtipo, int idpoliza) {
        ...
        //EntityManagerFactory emf=getEntityManager();
        //entity=emf.createEntityManager();
        System.out.println(" entro a punto saiPromocionPuntoSAicoo:"+"idusuario:"+idusuario+",session:"+sesion+",fechatrabajo:"+fechaTrabajo+",idorigenc:"+idorigenc+",idtipo:"+idtipo+",idpoliza:"+idpoliza);
        int is = 0;
        try {
    ...
    public List<SegurosComisionesDTO> distribucionSegurosComisionCobranza(AuxiliaresDTO auxiliaresDTO, Date fechaTrabajo, DistribucionPrestamoDTO distribucion, int diasvencidos) {
        List<SegurosComisionesDTO> segurosComisionesDTO = new ArrayList<>(0);
        ...
        if (distribucion.getSegHip().doubleValue() > 0) {
            ...
            for (SaiSeguroHipotecarioDTO saiSeguroHipotecarioDTO : seguroHipotecario) {
                SegurosComisionesDTO seguroComision = new SegurosComisionesDTO();
                ...
                if (saiComisionCobranzaDTO != null) {
                    if (saiComisionCobranzaDTO.getTasaComision() > 0 && saiComisionCobranzaDTO.getMontoComision() > 0) {
                        ...
                        for (String comision : comisiones) {
                            ...
                            SegurosComisionesDTO comisionCobranza = new SegurosComisionesDTO();
