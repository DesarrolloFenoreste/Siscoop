...
public class NumeroEnLetra {
     ...
     */
    public String convertNumberToLetter(String number) throws NumberFormatException {
     ...
     */
    public String convertNumberToLetter(double doubleNumber) throws NumberFormatException {
