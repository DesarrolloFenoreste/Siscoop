 ...
 */
@Stateless
public class WsSiscoopFoliosTarjetasService implements WsSiscoopFoliosTarjetasServiceLocal {
...
// el metodo buscaTarjetaTDD(String idtarjeta) lo utiliza SPEI  -- observacion de fredy
    @Override
    public WsSiscoopFoliosTarjetasDTO buscaTarjetaTDD(String idtarjeta) {
