 ...
 */
@Stateless
public class WsSiscoopResultadoFinalBancamovilFacade extends AbstractFacade<WsSiscoopResultadoFinalBancamovil> {
    ...
    */
    ...
    public WsSiscoopResultadoFinalBancamovilFacade() {
        super(WsSiscoopResultadoFinalBancamovil.class);
    }
