 ...
 */
@Stateless
public class WsSiscoopFoliosTarjetasFacade extends AbstractFacade<WsSiscoopFoliosTarjetas> {
    ...
    */
    ...
    public WsSiscoopFoliosTarjetasFacade() {
        super(WsSiscoopFoliosTarjetas.class);
    }
